/* Created Sun May 12 19:48:57 2019 by frac version 2.5.0 */
...
/* provider */
char *source_info[3] = {"frac","2.5.0","Sun May 12 19:48:57 2019"};
...
char *transtable[5] = {"play_1_t0","play_1_t1","play_1_t2","play_1_t3","play_1_t4"};
...
bool pre_0 (key s) {
  /* play_1_t0 */
  struct value *v = lookup(s);
  if (!((play_1_va.at[1].at[1] == 2))) return 0;
  if (!((play_1_va.at[1].at[2] == 2))) return 0;
  return 1;
 error: return 0;
}
